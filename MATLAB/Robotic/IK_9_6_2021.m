...
tic
%% DECLEARE VARIABLE
%d1 = 2; d2 = 5; d3 = 4; d4 = 3; d5 = 3; 
% d1=1; d2=1; d3=0; d4=2; d5=1;
d1=1; d2=5; d3=0; d4=7; d5=1; d6 = 1;
%% INPUT VALUE
% K = FK2_Func(30,30,30,30,0,30)
% X = K(1); Y = K(2); Z = K(3); Roll = K(4); Pitch = K(5); Yaw = K(6)
...
%           0     0     0       1];
T_0_EE = [
    0.0000   -0.0000    1.0000   10.4853
    0.0000   -1.0000   -0.0000   -0.0000
    1.0000    0.0000   -0.0000   -0.4142
         0         0         0    1.0000];
T_6_EE = [1 0 0 d6
          0 1 0 0
          0 0 1 d5
...
subplot(2,4,1);
flotrobot(the1_1, the2_1, the3_1, the4_1, the5_1, the6_1, d1, d2, d3, d4, d5,d6);
subplot(2,4,2);
flotrobot(the1_1, the2_1, the3_1, the4_2, the5_2, the6_2, d1, d2, d3, d4, d5,d6);
subplot(2,4,3);
flotrobot(the1_1, the2_2, the3_2, the4_3, the5_3, the6_3, d1, d2, d3, d4, d5,d6);
subplot(2,4,4);
flotrobot(the1_1, the2_2, the3_2, the4_4, the5_4, the6_4, d1, d2, d3, d4, d5,d6);
subplot(2,4,5);
flotrobot(the1_2, the2_3, the3_3, the4_5, the5_5, the6_5, d1, d2, d3, d4, d5,d6);
subplot(2,4,6);
flotrobot(the1_2, the2_3, the3_3, the4_6, the5_6, the6_6, d1, d2, d3, d4, d5,d6);
subplot(2,4,7);
flotrobot(the1_2, the2_4, the3_4, the4_7, the5_7, the6_7, d1, d2, d3, d4, d5,d6);
subplot(2,4,8);
flotrobot(the1_2, the2_4, the3_4, the4_8, the5_8, the6_8, d1, d2, d3, d4, d5,d6);
toc