...
s1_2 = sin(the1_2);  
%% The23
K_1 = c1_1*T_0_6(1,4) + s1_1*T_0_6(2,4) - d1;
K_2 = c1_2*T_0_6(1,4) + s1_2*T_0_6(2,4) - d1;
B   = T_0_6(3,4);
d_1 = (-sqr(d2) + (sqr(K_1) + sqr(B)) + sqr(d3 + d4))/(2*(d3 + d4));
d_2 = (-sqr(d2) + (sqr(K_2) + sqr(B)) + sqr(d3 + d4))/(2*(d3 + d4));
the23_BN1 = BASIC_TRIGONOMATRIX_FUNCTION_01(-B,K_1,d_1)
the23_BN2 = BASIC_TRIGONOMATRIX_FUNCTION_01(-B,K_2,d_2)
the23_1 = the23_BN1(1,:);   
the23_2 = the23_BN1(2,:);
the23_3 = the23_BN2(1,:);
the23_4 = the23_BN2(2,:);
if(the23_1 >= pi)
    the23_1 = the23_1 - 2*pi;
elseif(the23_1 <= -pi)
    the23_1 = the23_1 + 2*pi;
else the23_1 = the23_1;
end
if(the23_2 >= pi)
    the23_2 = the23_2 - 2*pi;
elseif(the23_2 <= -pi)
    the2_2 = the23_2 + 2*pi;
else the23_2 = the23_2;
end
if(the23_3 >= pi)
    the23_3 = the23_3 - 2*pi;
elseif(the23_3 <= -pi)
    the23_3 = the23_3 + 2*pi;
else the23_3 = the23_3;
end
if(the23_4 >= pi)
    the23_4 = the23_4 - 2*pi;
elseif(the23_4 <= -pi)
    the23_4 = the23_4 + 2*pi;
else the23_4 = the23_4;
end
c23_1 = cos(the23_1);
c23_2 = cos(the23_2);
c23_3 = cos(the23_3);
...
s23_3 = sin(the23_3);
s23_4 = sin(the23_4);
c2_1 = (K_1  - (d3 + d4)*s23_1)/d2;
c2_2 = (K_1  - (d3 + d4)*s23_2)/d2;
c2_3 = (K_2  - (d3 + d4)*s23_3)/d2;
c2_4 = (K_2  - (d3 + d4)*s23_4)/d2;
